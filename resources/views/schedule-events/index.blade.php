        ...
        <div class="print-hide flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            @if($canManageScheduleEvents)
                <div class="flex flex-wrap gap-2">
                    <a href="{{ route('schedule-events.manage') }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-rose-600 px-4 py-3 font-medium text-white shadow-sm ring-1 ring-rose-700/40 transition hover:bg-rose-500"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5"><path d="M5.25 3A2.25 2.25 0 003 5.25v9.5A2.25 2.25 0 005.25 17h9.5A2.25 2.25 0 0017 14.75v-9.5A2.25 2.25 0 0014.75 3h-9.5zm.75 2.25a.75.75 0 01.75-.75h6.5a.75.75 0 010 1.5h-6.5a.75.75 0 01-.75-.75zM6 9.25a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5h-.5A.75.75 0 016 9.25zm3.25-.75a.75.75 0 000 1.5h.5a.75.75 0 000-1.5h-.5zm3.25 0a.75.75 0 000 1.5h.5a.75.75 0 000-1.5h-.5zM6 12.75a.75.75 0 01.75-.75h.5a.75.75 0 010 1.5h-.5a.75.75 0 01-.75-.75zm3.25-.75a.75.75 0 000 1.5h.5a.75.75 0 000-1.5h-.5zm3.25 0a.75.75 0 000 1.5h.5a.75.75 0 000-1.5h-.5z" /></svg>{{ __('Gerenciar dias / feriados') }}</a>
